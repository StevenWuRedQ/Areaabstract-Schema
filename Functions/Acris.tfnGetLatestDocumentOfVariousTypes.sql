...
CREATE FUNCTION [Acris].[tfnGetLatestDocumentOfVariousTypes](@BBLE VARCHAR(11), @DocumentTypes VARCHAR(8)=NULL)
...
SELECT TOP 1 * FROM acris.tfnGetDocumentsOfVariousTypes(@BBLE,@DocumentTypes)
RETURN;
END;
GO
