...
-- =============================================
CREATE PROCEDURE [Acris].[MortgageDeedMasterDataDailyImport](@DateTimeStampStr AS VARCHAR(20))
AS
BEGIN
	...
	BEGIN TRY
		IF (@InTransaction=1)
			SAVE TRANSACTION LTMDMasterDataDailyImport
		ELSE
			BEGIN TRANSACTION 
	...
	BEGIN CATCH
		...
		ELSE
			ROLLBACK TRANSACTION LTMDMasterDataDailyImport;
		THROW;
	END CATCH
END;
